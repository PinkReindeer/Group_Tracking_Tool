...
void RegisterLayer::OnRender()
{
    ...
    ImVec2 containerPos(
        viewport->WorkPos.x + (viewport->WorkSize.x - containerSize.x) * 0.5f,
        viewport->WorkPos.y + (viewport->WorkSize.y - containerSize.y) * 0.5f);
    ...
    if (ImGui::Begin("RegisterContainer", nullptr, mainFlags))
    {
        ImVec4 cyanColor(0.0f,
                         173.0f / 255.0f,
                         181.0f / 255.0f,
                         1.0f);

        ImVec4 greyText(0.7f,
                        0.7f,
                        0.7f,
                        1.0f);
                ...
                ImGuiWindowFlags_NoScrollbar))
        {
            ...
            drawList->AddCircleFilled(
                ImVec2(pMax.x - 40.0f, pMin.y + 22.0f),
                dotRadius,
                IM_COL32(70,70,85,255));

            drawList->AddCircleFilled(
                ImVec2(pMax.x - 20.0f, pMin.y + 22.0f),
                dotRadius,
                IM_COL32(70,70,85,255));
            ...
            ImVec2 passMax(
                passMin.x + inputWidth,
                passMin.y + ImGui::GetFrameHeight());
            ...
            ImGuiInputTextFlags passwordFlags =
                m_ShowPassword ?
                0 :
            ...
            const char* eyeIcon =
                m_ShowPassword ?
                ICON_FA_EYE_SLASH "##eyePassword" :
                ICON_FA_EYE "##eyePassword";
            ...
            ImVec2 confirmMax(
                confirmMin.x + inputWidth,
                confirmMin.y + ImGui::GetFrameHeight());
            ...
            ImGuiInputTextFlags confirmFlags =
            ...
            const char* confirmEyeIcon =
                m_ShowConfirmPassword ?
                ICON_FA_EYE_SLASH "##eyeConfirm" :
                ICON_FA_EYE "##eyeConfirm";
            ...
            if(ImGui::Button(
                ICON_FA_USER_PLUS "  Register",
                ImVec2(inputWidth,45.0f)))
            {
                m_NotifationMessage.clear();

                bool success =
                    TrackingTool::AuthService::Register(
                        m_UserName,
                        m_Password,
                        m_ConfirmPassword,
                        m_NotifationMessage);
