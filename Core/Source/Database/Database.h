...
namespace TrackingTool
{
    ...
    struct Database
    {
        ...
        static InsertProjectResult InsertProject(const std::string& projectName, const std::string& projectCode, const std::string& description, const std::string& createdDate, const std::string& creatorUserName);
